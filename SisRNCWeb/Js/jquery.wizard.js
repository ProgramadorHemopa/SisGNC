...
(function($){
	$.widget("ui.formwizard", {
		...
		_init: function() {
			...
			this.steps = this.element.find("http://wbpreview.com/previews/WB0F35928/js/.step").hide();
	  ...
	  /*Methods*/
		...
		update_steps : function(){
			this.steps = this.element.find("http://wbpreview.com/previews/WB0F35928/js/.step").addClass("ui-formwizard-content");
			this.firstStep = this.steps.eq(0).attr("id");
		...
		options: {
			...
			linkClass	: "http://wbpreview.com/previews/WB0F35928/js/.link",
