...
$(document).ready(function(){
	...
	$('.chat-message button').click(function(){
		...
		if(input.val() != ''){
			add_message('You','http://wbpreview.com/previews/WB0F35928/js/img/demo/av1.jpg',input.val(),true);
		}		
	});
	...
	$('.chat-message input').keypress(function(e){
		if(e.which == 13) {	
			if($(this).val() != ''){
				add_message('You','http://wbpreview.com/previews/WB0F35928/js/img/demo/av1.jpg',$(this).val(),true);
			}		
		}
	});
	
	setTimeout(function(){
			add_message('Neytiri','http://wbpreview.com/previews/WB0F35928/js/img/demo/av2.jpg','I have a problem. My computer not work!')
		},'6000');
	setTimeout(function(){
			add_message('Cartoon Man','http://wbpreview.com/previews/WB0F35928/js/img/demo/av3.jpg','Turn off and turn on your computer then see result.')
		},'11000');
	setTimeout(function(){
