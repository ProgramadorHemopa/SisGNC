<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoAnalise.aspx.cs" 
    Inherits="HMP.WebInterface.SisRNCWeb.Www.Pages.TipoAnalise" 
    MasterPageFile="~/Aut/AutAdmin.master" Title="SisGNCWeb - Cadastro de Tipos de Análise" culture="auto" uiculture="auto"  %>    
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:UpdatePanel ID="UpdatePanelPrincipal" runat="server">
    ...
    <div class="container-fluid">
                    ...
                    <div class="widget-content nopadding">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="txtTPANL_DESCRICAO" runat="server"></asp:TextBox>
                                </div>	
                            </div>

                            <div class="form-actions">
                                <asp:Button ID="Button1" runat="server" Text="Salvar" CssClass="btn btn-success" OnClick="btnOk_Click" />
                            </div>
                            ...
                            <div class="widget-content nopadding">
                                <asp:GridView ID="grdMain" Width="100%" runat="server" EmptyDataText="Nenhum registro encontrado" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TPANL_DESCRICAO" HeaderText="Tipo" />
        ...
        <asp:HiddenField ID="hidTPANL_ID" runat="server" />                                                                                                                
