<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoOcorrencia.aspx.cs" 
    Inherits="HMP.WebInterface.SisRNCWeb.Www.Pages.TipoOcorrencia" 
    MasterPageFile="~/Aut/AutAdmin.master" Title="SisGNCWeb - Cadastro de Tipos de Ocorrência" culture="auto" uiculture="auto"  %>    
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:UpdatePanel ID="UpdatePanelPrincipal" runat="server">
    ...
    <div class="container-fluid">
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <h5>Cadastro -  Tipos de Ocorrência
                        </h5>
                    </div>
                    <div class="widget-content nopadding">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="txtTPOCR_DESCRICAO" runat="server"></asp:TextBox>
                                </div>	
                            </div>
                            ...
                            <div class="widget-content nopadding">
                                <asp:GridView ID="grdMain" Width="100%" runat="server" EmptyDataText="Nenhum registro encontrado" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TPOCR_DESCRICAO" HeaderText="Tipo" />
        ...
        <asp:HiddenField ID="hidTPOCR_ID" runat="server" />                                                                                                                
