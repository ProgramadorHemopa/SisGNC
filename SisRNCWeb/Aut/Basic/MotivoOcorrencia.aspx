<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotivoOcorrencia.aspx.cs" 
    Inherits="HMP.WebInterface.SisRNCWeb.Www.Pages.MotivoOcorrencia" 
    MasterPageFile="~/Aut/AutAdmin.master" Title="SisGNCWeb - Cadastro de Motivos da Ocorrência" culture="auto" uiculture="auto"  %>    
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:UpdatePanel ID="UpdatePanelPrincipal" runat="server">
    ...
    <div class="container-fluid">
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <h5>Cadastro - Motivos da Ocorrência
                        </h5>
                    </div>
                    <div class="widget-content nopadding">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="txtMTV_DESCRICAO" runat="server"></asp:TextBox>
                                </div>	
                            </div>
                            ...
                            <div class="widget-content nopadding">
                                <asp:GridView ID="grdMain" Width="100%" runat="server" EmptyDataText="Nenhum registro encontrado" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MTV_DESCRICAO" HeaderText="Tipo" />
        ...
        <asp:HiddenField ID="hidMTV_ID" runat="server" />                                                                                                                
