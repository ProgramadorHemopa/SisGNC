...
{
    public partial class RegistroNaoConformidadeAdmin : BaseAutPage//System.Web.UI.Page
    {
        ...
        private void LoadRespAbertura(decimal pMATRICULA)
        {
            ...
            {
                ltable = NC_OcorrenciaDo.GetFuncionariosByMatricula(pMATRICULA, LocalInstance.ConnectionInfo);
                ViewState["WRK_TABLE_FUNCIONARIOS"] = ltable;
                ddlFuncionario.DataSource = ltable;
        ...
        private bool ValidarInsertAnaliseCritica()
        {
            ...
            else //Se Cancelado
            {
                ...
                {
                    lMensagem += "-Justificativa do Cancelamento <br/>";
                    lValido = false;
                }
            }
        ...
        private void InterfaceUpdate(decimal pOCR_ID)
        {
            try
            {
                DataFieldCollection lFields = new DataFieldCollection();
                ...
                lFields.Add(NC_OcorrenciaQD._OCR_DESCRICAO, txtOCR_DESCRICAO.Text);
                lFields.Add(NC_OcorrenciaQD._UNIDADE_RESPRESOLUCAO, ddlUnidadeRespResolucao.SelectedValue);
                lFields.Add(NC_OcorrenciaQD._STCOCR_ID, ddlSTCOCR_ID.SelectedValue.DBToDecimal());
                lFields.Add(NC_OcorrenciaQD._OCR_REGDATE, DateTime.Now);
                lFields.Add(NC_OcorrenciaQD._OCR_REGUSER, ((LoginUserDo)Session["_SessionUser"]).MATRICULA);
                lFields.Add(NC_OcorrenciaQD._OCR_STATUS, LocalInstance.StatusAtivo);
                ...
                lReturn = NC_OcorrenciaDo.Update(lFields, LocalInstance.ConnectionInfo);
        ...
        private void InterfaceUpdateAcaoImediata(decimal pSNTAC_ID)
        {
            try
            {
                ...
                {
                    MessageBox1.wuc_ShowMessage("Ação Imediata/Remoção do Sintoma salva com sucesso.", 1);
                }
            }
            catch (WebManagerException e)
            {
        ...
        private void InterfaceUpdateAnaliseCritica(decimal pANC_ID)
        {
            try
            {
                DataFieldCollection lFields = new DataFieldCollection();
                ...
                //Análise Crítica
                lFields.Add(NC_AnaliseCriticaQD._ANC_ID, pANC_ID);
                lFields.Add(NC_AnaliseCriticaQD._ANC_SITUACAO, rblANC_SITUACAO.SelectedValue);
                lFields.Add(NC_AnaliseCriticaQD._ANC_DATA, txtANC_DATA.Text.DBToDateTime());
                lFields.Add(NC_AnaliseCriticaQD._TPANL_ID, ddlTIPOANALISE.SelectedValue);
                lFields.Add(NC_AnaliseCriticaQD._MATRICULA_RESPPA, ddlRespPA.SelectedValue);
                ...
                lReturn = NC_AnaliseCriticaDo.Update(lFields, LocalInstance.ConnectionInfo);
                ...
                else
                {
                    ...
                    MessageBox1.wuc_ShowMessage("Análise Crítica salva com sucesso.", 1);
                }
            }
            catch (WebManagerException e)
            {
        ...
        private void InterfaceUpdateDiagramaCausaEfeito()
        {
            try
            {
                ...
                {
                    MessageBox2.wuc_ShowMessage("Análise de Causa salva com sucesso.", 1);
                }
            }
            catch (WebManagerException e)
            {
        ...
        private void InterfaceIncludeVerificacaoEficacia(decimal pPLNAC_ID)
        {
            try
            {
                ...
                //lFields.Add(NC_VerificarEficaciaQD._VRFEFC_SITUACAO, txtANCE_OBSERVACAO.Text);
        ...
        private void InterfaceUpdateVerificacaoEficacia(decimal pVRFEFC_ID)
        {
            try
            {
                DataFieldCollection lFields = new DataFieldCollection();
                ...
                //VerificacaoEficacia
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_ID, pVRFEFC_ID);
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_DATA, txtVRFEFC_DATA.Text.DBToDateTime());
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_OBSERVACAO, txtVRFEFC_OBSERVACAO.Text);
                //lFields.Add(NC_VerificarEficaciaQD._VRFEFC_SITUACAO, rblVRFEFC_SITUACAO.SelectedValue);
                //lFields.Add(NC_VerificarEficaciaQD._MATRICULA_REGISTROU, ((LoginUserDo)Session["_SessionUser"]).MATRICULA);
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_REGDATE, DateTime.Now);
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_REGUSER, ((LoginUserDo)Session["_SessionUser"]).MATRICULA);
                lFields.Add(NC_VerificarEficaciaQD._VRFEFC_STATUS, LocalInstance.StatusAtivo);
                ...
                lReturn = NC_VerificarEficaciaDo.Update(lFields, LocalInstance.ConnectionInfo);
                ...
                else
                {
                    ...
                    MessageBox1.wuc_ShowMessage("Verificação da Eficácia salva com sucesso.", 1);
                }
            }
            catch (WebManagerException e)
            {
        ...
        private void LoadDadosOcorrencia(decimal pOCR_ID)
        {
            try
            {
                ...
                if (lTable.Rows.Count > 0)
                {
                    ...
                    ddlSTCOCR_ID.SelectedValue = lTable.Rows[0][NC_OcorrenciaQD._STCOCR_ID.Name].ToString();
                    ...
                    ddlTipoOcorrencia.Enabled = true;
                    txtOCR_DATAOCORRENCIA.Enabled = true;
                    ddlUnidadeOcorrencia.Enabled = true;
                    ddlMotivoOcorrencia.Enabled = true;
                    chkNormas.Enabled = true;
                    txtOCR_DESCRICAO.Enabled = true;
                    fuAnexo.Enabled = true;
                    ddlUnidadeRespResolucao.Enabled = true;
        ...
        {
            DataTable lTable = (DataTable)ViewState["WRK_TABLE_UNIDADES"];
        ...
        private void LoadSituacaoOcorrencia(string pSTCOCR_ID)
        {
            ...
            btnOkAnaliseCritica.Visible = true;
            btnCancelarAnaliseCritica.Visible = true;
            btnOkCausaEfeito.Visible = true;
            btnOutrosCausaEfeito.Visible = true;
            btnOkVerificacao.Visible = true;
        }
        ...
        private void LoadAnaliseCritica()
        {
            ...
            if (lTable.Rows.Count > 0)
            {
                ...
                hidANC_ID.Value = lTable.Rows[0][NC_AnaliseCriticaQD._ANC_ID.Name].ToString();
                ...
                rblANC_SITUACAO.Enabled = true;
                txtANC_DATA.Enabled = true;
                ddlTIPOANALISE.Enabled = true;
                ddlRespPA.Enabled = true;
                txtANC_JUSTIVACANCELAMENTO.Enabled = true;
            }
            else
        ...
        private void LoadPlanoDeAcao()
        {
            ...
            if (lTable.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < lTable.Rows.Count; i++)
                {
                    ...
                    if (lTable.Rows[i][NC_PlanoAcaoQD._PLNAC_SITUACAO.Name].DBToDecimal() == (decimal)SituacaoPlanoAcao.Executado)
                    {
                    ...
                    if (lTable.Rows[i][NC_PlanoAcaoQD._PLNAC_SITUACAO.Name].DBToDecimal() == (decimal)SituacaoPlanoAcao.NaoAprovado)
                    {
        ...
        protected void grdEficacia_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName != "Page") //Paginação                                                                          
                {
                    ...
                    {
                        DataTable lTable = (DataTable)ViewState["WRK_TABLE_VERIFICAREFICACIA"];

                        if (lTable.Rows.Count > 0)
                        {
                            divNovaVerificaoEficacia.Visible = true;
                            hidVRFEFC_ID.Value = lTable.Rows[iIndice][NC_VerificarEficaciaQD._VRFEFC_ID.Name].ToString();
                            txtVRFEFC_DATA.Text = lTable.Rows[iIndice][NC_VerificarEficaciaQD._VRFEFC_DATA.Name].DBToDateTime().ToShortDateString();
                            //rblVRFEFC_SITUACAO.SelectedValue = lTable.Rows[iIndice][NC_VerificarEficaciaQD._VRFEFC_SITUACAO.Name].ToString();
                            txtVRFEFC_OBSERVACAO.Text = lTable.Rows[iIndice][NC_VerificarEficaciaQD._VRFEFC_OBSERVACAO.Name].ToString();
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            if (hidOCR_ID.Value == "")
                ...
                InterfaceUpdate(hidOCR_ID.Value.DBToDecimal());
        ...
        protected void btnOkAnaliseCritica_Click(object sender, EventArgs e)
        {
            if (hidANC_ID.Value == "")
                ...
                InterfaceUpdateAnaliseCritica(hidANC_ID.Value.DBToDecimal());
        }
        ...
        {
            if (hidVRFEFC_ID.Value == "")
                InterfaceIncludeVerificacaoEficacia(hidPLNAC_ID.Value.DBToDecimal());
            else
                InterfaceUpdateVerificacaoEficacia(hidVRFEFC_ID.Value.DBToDecimal());
        }
