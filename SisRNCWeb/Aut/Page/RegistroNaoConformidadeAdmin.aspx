<%@ Page Title="SisGNCWeb - Registro de Não Conformidades" Language="C#" MasterPageFile="~/Aut/AutAdmin.master" AutoEventWireup="true" CodeFile="RegistroNaoConformidadeAdmin.aspx.cs" 
    Inherits="HMP.WebInterface.SisRNCWeb.Www.Pages.RegistroNaoConformidadeAdmin" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="form-horizontal">
                                ...
                                <div runat="server" id="trEdicao" visible="false">
                                        <div class="control-group">
                                         ...
                                         <div class="control-group">
                                            <label class="control-label">Situação Ocorrencia:</label>
                                            <div class="controls">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div style="OVERFLOW-Y:scroll; WIDTH:80%; HEIGHT:150px">
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnOk" runat="server" Text="Salvar Dados da Ocorrência" CssClass="btn btn-success" OnClick="btnOk_Click" />
                            </div>
                                            ...
                                            <div class="widget-content nopadding">
                                                <div class="form-horizontal">
                                                      <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <asp:TextBox ID="txtSNTAC_DATA" runat="server" Enabled="true" ></asp:TextBox>
                                    ...
                                    <div class="accordion-heading">
                                        ...
                                        <div class="collapse in accordion-body" id="collapseGCausaEfeito">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">Data Registro:</label>
                                                <div class="controls">
                                                    <asp:TextBox ID="txtANCE_DATA" runat="server" Enabled="true" ></asp:TextBox>
                                            ...
                                            <div class="controls">
                                                <asp:RadioButtonList ID="rblAnaliseCausa" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblAnaliseCausa_SelectedIndexChanged" runat="server">
                                                    ...
                                                    <asp:ListItem Text="Outros" Value="1"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                                    ...
                                                    <div id="tab2d" class="tab-pane active">
                                                        ...
                                                        <div class="widget-content nopadding">
                                                            <div class="form-horizontal">
                                                                ...
                                                                utilizada pela Administração para o gerenciamento e o Controle da Qualidade (CQ) em processos diversos de manipulação das fórmulas. <br />
                                                                    - Método: toda a causa envolvendo o método que estava sendo executado o trabalho; <br />
                                                                    - Matéria-prima: toda causa que envolve o material que estava sendo utilizado no trabalho; <br />
                                                                    - Mão-de-obra: toda causa que envolve uma atitude do colaborador (ex. procedimento inadequado, pressa, imprudência, ato inseguro, etc.); <br />
                                                                    - Máquinas: toda causa envolvendo a máquina que estava sendo operada; <br />
                                                                    - Medida: toda causa que envolve uma medida tomada anteriormente para modificar o processo, etc; <br />
                                                                ...
                                                                dimensionamento inadequado dos equipamentos, etc.); <br />
                                                                    - Gestão: Descumprimentos das normas preconizadas pelo Sistema de Gestão da Qualidade e legislações. <br />
                                                  ...
                                                  <div id="divNovaVerificaoEficacia" runat="server" visible="false">
                                                    ...
                                                    <div class="widget-content nopadding">
                                                        <asp:GridView ID="grdEficacia" Width="100%" runat="server" EmptyDataText="Nenhum registro encontrado" AutoGenerateColumns="False" PageSize="10"
                                                            CssClass="table table-bordered table-striped table-hover" OnRowCommand="grdEficacia_RowCommand"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:ButtonField CommandName="Editar" ButtonType="Image" ImageUrl="~/Skin/Default/Img/Icons/ico_lista.gif"      
                                                                   ItemStyle-HorizontalAlign="Center" HeaderText="Editar" />
                                                            </Columns>
    ...
    <asp:HiddenField ID="hidANC_ID" runat="server" />
    <asp:HiddenField ID="hidVRFEFC_ID" runat="server" />
</asp:Content>
