...
{
    public partial class ConsultaFluxoOcorrencia: BaseAutPage
    {
        ...
        private void InterfacePesquisa()
        {
            ...
            ViewState["WRK_TABLE"] = NC_OcorrenciaDo.GetFluxoOcorrenciaByParametros(ddlFuncionario.SelectedValue.DBToDecimal(), txtDataInicio.Text.DBToDateTime().ToString("yyyy-MM-dd"), txtDataFim.Text.DBToDateTime().ToString("yyyy-MM-dd"), ddlTipoOcorrencia.SelectedValue.DBToDecimal(),
                ddlUnidadeOcorrencia.SelectedValue.DBToDecimal(), ddlMotivoOcorrencia.SelectedValue.DBToDecimal(), 
                ddlUnidadeRespResolucao.SelectedValue.DBToDecimal(),
                ddlSTCOCR_ID.SelectedValue.DBToDecimal(), txtOCR_NUMERO.Text, LocalInstance.ConnectionInfo);

            Session["WRK_TABLE"] = ((DataTable)ViewState["WRK_TABLE"]);
