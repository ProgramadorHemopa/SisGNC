<%@ WebHandler Language="C#" Class="AutoCompletePessoaID" %>
...
public class AutoCompletePessoaID : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.QueryString["q"] != null)
        {
            ...
            lTable = PessoaDo.GetPesForAuto(LocalInstance.ConnectionInfo, pName);
