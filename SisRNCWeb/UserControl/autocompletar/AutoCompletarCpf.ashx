<%@ WebHandler Language="C#" Class="AutoCompletarCpf" %>
...
using System.Data;
public class AutoCompletarCpf : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.QueryString["q"] != null)
        {
            ...
            lTable = PessoaDo.GetPesForAutoCPF(LocalInstance.ConnectionInfo, pName);
