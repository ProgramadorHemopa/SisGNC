...
{                                                                                     
     [Serializable] 
     public class NC_SituacaoOcorrenciaDo
	    {                                                                                    
      ...
      {                                                                                        
        GenericDataObject.ValidateRequired(NC_SituacaoOcorrenciaQD._STCOCR_ID, pValues, pResult);
      }                                                                                        
 ...
 {                                                                                             
     ...
     OperationResult lReturn = new OperationResult(NC_SituacaoOcorrenciaQD.TableName, NC_SituacaoOcorrenciaQD.TableName);      
     ...
     {                                                                                         
         ...
         {                                                                                     
             ...
             lInsert = new InsertCommand(NC_SituacaoOcorrenciaQD.TableName);                                   
     ...
     {                                                                                                                                     
         ...
         {                                                                                                                                 
             ...
             {                                                                                                                             
                 ...
                 lUpdate = new UpdateCommand(NC_SituacaoOcorrenciaQD.TableName);                                                                           
                                                                                                                                           
                 lReturn.Trace("Adicionando campos ao objeto de update");                                                           
                 foreach (DataField lField in pValues.Keys)
                 {
                    if ((lField.Name != NC_SituacaoOcorrenciaQD._STCOCR_ID.Name))
         ...
         public static DataTable GetAllNC_SituacaoOcorrencia
         (                                                           
             ConnectionInfo pInfo                                    
         )                                                           
         {                                                           
             ...
             lQuery = NC_SituacaoOcorrenciaQD.qNC_SituacaoOcorrenciaList;
             lQuery += " WHERE STCOCR_STATUS='A'";
